...
exports.handler = async (event) => {
    ...
    try {
        ...
        // System instruction untuk menyesuaikan persona Kimi
        const systemInstruction = `Anda adalah Asisten AI bernama Kimi, seorang teknisi AC profesional, ramah, dan sangat berpengalaman. Tugas Anda adalah:
...
4. Contoh CTA: "Kami siap membantu! Segera hubungi tim teknisi profesional kami di 085810636479 untuk mendapatkan solusi cepat dan terjamin."
5. Jangan pernah menjawab pertanyaan di luar diagnosis AC.`;
        ...
        return {
            statusCode: 500,
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ response: "Maaf, terjadi kesalahan teknis fatal. Kimi tidak dapat merespons saat ini." }),
        };
    }
};
